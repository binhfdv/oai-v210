...
exclude_param = [0, 1, 2, 3, 4, 5, 6, 7, 8, 14, 22, 27, 28, 29]  # indexes of KPIs to be excluded from normalization and classification
def process_norm_params(all_feats_raw, colsparam_dict):
    ...
    slice_len = 32 #colsparam_dict['info']['mean_ctrl_sample'].shape[0]
    ...
    return colsparams, indexes_to_keep, map_feat2KPI, num_feats, slice_len, 0  #colsparam_dict['info']['mean_ctrl_sample']
