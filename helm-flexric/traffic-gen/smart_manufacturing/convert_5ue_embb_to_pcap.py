...
"""
Convert 5-UE eMBB traffic CSV to PCAP (raw IP, no Ethernet header).
Designed for 5-UE eMBB slice scenario with IPs: 12.1.1.100 - 12.1.1.104

Usage:
    # Process entire CSV
    python3 convert_5ue_embb_to_pcap.py ue1_5ue_traffic.csv ue_pcaps_5ue/ue1.pcap --ue UE1

    # Process in 20% chunks (recommended for large files)
    python3 convert_5ue_embb_to_pcap.py ue1_5ue_traffic.csv ue_pcaps_5ue/ue1 --ue UE1 --chunks 5

    # Process a specific chunk only
    python3 convert_5ue_embb_to_pcap.py ue1_5ue_traffic.csv ue_pcaps_5ue/ue1.pcap --ue UE1 --chunk 1 --total-chunks 5
"""
...
MAPPING_FILE = 'device_to_5ue_embb_mapping.csv'

UE_IPS = {
    'UE1': '12.1.1.100',  # Mobile Units Group 1
    'UE2': '12.1.1.101',  # Mobile Units Group 2
    'UE3': '12.1.1.102',  # Camera Controllers
    'UE4': '12.1.1.103',  # Quality Cameras
    'UE5': '12.1.1.104',  # Quality Nodes
}
...
def main():
    parser = argparse.ArgumentParser(description='Convert 5-UE eMBB CSV to PCAP')
