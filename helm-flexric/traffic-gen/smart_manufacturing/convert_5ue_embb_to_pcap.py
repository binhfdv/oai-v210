...
Usage:
    python3 convert_5ue_to_pcap.py ue1_embb_5ue_traffic.csv ue_pcaps_5ue_embb/ue1.pcap --ue UE1
    python3 convert_5ue_to_pcap.py ue2_embb_5ue_traffic.csv ue_pcaps_5ue_embb/ue2.pcap --ue UE2

Or process in chunks:
    python3 convert_5ue_to_pcap.py ue1_embb_5ue_traffic.csv ue_pcaps_5ue_embb/ue1 --ue UE1 --chunks 5
"""
...
def load_device_mapping(mapping_file='device_to_5ue_embb_mapping.csv'):
