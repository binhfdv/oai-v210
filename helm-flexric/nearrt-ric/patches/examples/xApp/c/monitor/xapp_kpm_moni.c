...
void log_int_value(byte_array_t name, meas_record_lst_t meas_record)
{
  ...
  } else if (cmp_str_ba("TB.TotNbrDlInitial", name) == 0) {
    printf("TB.TotNbrDlInitial = %d [TBs]\n", meas_record.int_val);
  } else if (cmp_str_ba("TB.IntialErrNbrDl", name) == 0) {
    printf("TB.IntialErrNbrDl = %d [TBs]\n", meas_record.int_val);
  } else if (cmp_str_ba("TB.TotNbrDl.sum", name) == 0) {
    printf("TB.TotNbrDl.sum = %d [TBs]\n", meas_record.int_val);
  } else if (cmp_str_ba("TB.ResidualErrNbrDl", name) == 0) {
    printf("TB.ResidualErrNbrDl = %d [TBs]\n", meas_record.int_val);
  } else if (cmp_str_ba("TB.TotNbrUlInit", name) == 0) {
    printf("TB.TotNbrUlInit = %d [TBs]\n", meas_record.int_val);
  } else if (cmp_str_ba("TB.ErrNbrUlInitial", name) == 0) {
    printf("TB.ErrNbrUlInitial = %d [TBs]\n", meas_record.int_val);
  } else if (cmp_str_ba("TB.TotNbrUl.sum", name) == 0) {
    printf("TB.TotNbrUl.sum = %d [TBs]\n", meas_record.int_val);
  } else if (cmp_str_ba("TB.ResidualErrNbrUl", name) == 0) {
    printf("TB.ResidualErrNbrUl = %d [TBs]\n", meas_record.int_val);
  } else if (cmp_str_ba("DRB.RlcPacketDropRateDl", name) == 0) {
    printf("DRB.RlcPacketDropRateDl = %d [1/1000]\n", meas_record.int_val);
  } else if (cmp_str_ba("DRB.PacketLossRateUl", name) == 0) {
    printf("DRB.PacketLossRateUl = %d [1/1000]\n", meas_record.int_val);
  } else if (cmp_str_ba("DRB.RlcSduLatencyDl", name) == 0) {
    printf("DRB.RlcSduLatencyDl = %d [μs]\n", meas_record.int_val);
  } else if (cmp_str_ba("RRC.ConnMean", name) == 0) {
    printf("RRC.ConnMean = %d [UEs]\n", meas_record.int_val);
  } else if (cmp_str_ba("RRC.ConnMax", name) == 0) {
    printf("RRC.ConnMax = %d [UEs]\n", meas_record.int_val);
  } else {
